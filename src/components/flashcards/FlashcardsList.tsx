  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setShowCreateModal(true)}>Dodaj fiszkę</Button>
      </div>
      ...
      <div className="flex gap-2 mb-6">
        ...
        <Button variant={filter === "ai" ? "default" : "outline"} size="sm" onClick={() => setFilter("ai")}>
      ...
      {filteredFlashcards.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed">
          ...
          {filter === "all" && <Button onClick={() => setShowCreateModal(true)}>Dodaj pierwszą fiszkę</Button>}
        </div>
      ) : (
      ...
      {/* Modals */}
      {showCreateModal && <CreateFlashcardModal onClose={() => setShowCreateModal(false)} onSuccess={handleSuccess} />}
